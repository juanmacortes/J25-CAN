<?php /* Smarty version Smarty-3.1.7, created on 2014-08-03 00:30:00
         compiled from "/home/juanmanu/public_html/Can2.0/includes/runtime/../../layouts/vlayout/modules/Settings/SharingAccess/ListRules.tpl" */ ?>
<?php /*%%SmartyHeaderCode:214722503853dd8288d1d013-81264362%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76c84c5df2c6efbe9b2aae6ab66743594f08c0b5' => 
    array (
      0 => '/home/juanmanu/public_html/Can2.0/includes/runtime/../../layouts/vlayout/modules/Settings/SharingAccess/ListRules.tpl',
      1 => 1373802546,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '214722503853dd8288d1d013-81264362',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53dd8288e5568',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53dd8288e5568')) {function content_53dd8288e5568($_smarty_tpl) {?>
<div class="row-fluid ruleListContainer"><hr><div class="title padding-bottom1per"><span class="themeLinkColor padding-left1per"><!-- Check if the module should the for module to get the translations--><strong><?php echo vtranslate('LBL_SHARING_RULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
<?php }?> :</strong></span><span class="pull-right padding-right1per"><button class="btn addButton addCustomRule" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getCreateRuleUrl();?>
"><strong><?php echo vtranslate('LBL_ADD_CUSTOM_RULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</strong></button></span></div><div class="contents padding1per"><?php if ($_smarty_tpl->tpl_vars['RULE_MODEL_LIST']->value){?><table class="table table-bordered table-condensed customRuleTable"><thead><tr class="customRuleHeaders"><th><?php echo vtranslate('LBL_RULE_NO',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
