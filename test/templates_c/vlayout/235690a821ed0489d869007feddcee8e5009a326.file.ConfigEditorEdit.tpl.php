<?php /* Smarty version Smarty-3.1.7, created on 2014-08-03 00:32:00
         compiled from "/home/juanmanu/public_html/Can2.0/includes/runtime/../../layouts/vlayout/modules/Settings/Vtiger/ConfigEditorEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:64588211053dd83006a9401-67642119%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '235690a821ed0489d869007feddcee8e5009a326' => 
    array (
      0 => '/home/juanmanu/public_html/Can2.0/includes/runtime/../../layouts/vlayout/modules/Settings/Vtiger/ConfigEditorEdit.tpl',
      1 => 1373802546,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64588211053dd83006a9401-67642119',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53dd83007fe6b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53dd83007fe6b')) {function content_53dd83007fe6b($_smarty_tpl) {?>
...
"><div class="widget_header row-fluid"><div class="span8"><h3><?php echo vtranslate('LBL_CONFIG_EDITOR',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></div></div></div><hr><?php $_smarty_tpl->tpl_vars['FIELD_VALIDATION'] = new Smarty_variable(array('HELPDESK_SUPPORT_EMAIL_ID'=>array('name'=>'Email'),'upload_maxsize'=>array('name'=>'NumberRange5'),'history_max_viewed'=>array('name'=>'NumberRange5'),'listview_max_textlength'=>array('name'=>'NumberRange100'),'list_max_entries_per_page'=>array('name'=>'NumberRange100')), null, 0);?><table class="table table-bordered table-condensed themeTableColor"><thead><tr class="blockHeader"><th colspan="2"><?php echo vtranslate('LBL_CONFIG_FILE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
?><tr><td width="30%"><label class="muted pull-right marginRight10px"><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_DETAILS']->value['label'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></td><td style="border-left: none;" class="row-fluid"><?php if ($_smarty_tpl->tpl_vars['FIELD_DETAILS']->value['fieldType']=='picklist'){?><span class="span3"><select class="select2 row-fluid" name="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
