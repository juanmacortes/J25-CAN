...
<html>
	<head>
		<title>CAN Página de ingreso </title>
		...
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="#"></a> | 
						<a href="#">CAN Video Tutoriales</a> | 
						<a href="http://casaroca.org/bogota/">Casa Sobre la Roca</a> 
					</div>
				</div>
			</div>
			<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Sácale el provecho a CAN </h2></div>
										<ul class="bxslider">
											<li>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Ingresa a CAN</h3>
											</div>
											<form class="form-horizontal login-form" style="margin:0;" action="index.php?module=Users&action=Login" method="POST">
												...
												{if isset($smarty.request.fpError)}
													<div class="alert alert-error">
														<p>Nombre de usuario o correo invalido.</p>
													</div>
												{/if}
												{if isset($smarty.request.status)}
													<div class="alert alert-success">
														<p>Se ha enviado un correo, por favor, verífique su e-mail.</p>
													</div>
												{/if}
												{if isset($smarty.request.statusError)}
													<div class="alert alert-error">
														<p>El servidor de Correo no está configurado.</p>
													</div>
												{/if}
												...
												<div class="control-group">
													<label class="control-label" for="password"><b>Contraseña</b></label>
													<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit" class="btn btn-primary sbutton">Entrar</button>
														&nbsp;&nbsp;&nbsp;<a>¿Olvidó su clave?</a>
													</div>
												</div>
											...
											<div class="login-subscript">
												<small> Desarrollado por el Flaco -CRM {$CURRENT_VERSION}</small>
											</div>
										</div>
										...
										<div class="login-box hide" id="forgotPasswordDiv">
											<form class="form-horizontal login-form" style="margin:0;" action="forgotPassword.php" method="POST">
												<div class="">
													<h3 class="login-header">Olvidó su contraseña</h3>
												</div>
												<div class="control-group">
													<label class="control-label" for="user_name"><b>Usuario</b></label>
													<div class="controls">
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									<a href="http://www.jmas25.com"> jmas25.com</a> | 
									<a href="javascript:mypopup();">Licenciamiento</a> | 
									<a href="https://www.vtiger.com/products/crm/privacy_policy.html">Política de Privacidad</a> </small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/nuevajuventudbogota"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/NuevaJuventudBo"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="#"><img src="#"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="http://www.youtube.com/user/jmas25"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
